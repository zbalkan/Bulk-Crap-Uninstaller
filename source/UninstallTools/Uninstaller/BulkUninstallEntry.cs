...
namespace UninstallTools.Uninstaller
{
    public class BulkUninstallEntry
    {
        ...
        private void FindAndAddProcessesToWatch(ICollection<Process> watchedProcesses, ISet<int> runningProcessIds)
        {
        ...
        /// </summary>
        private static IEnumerable<Process> CleanupDeadProcesses(IEnumerable<Process> watchedProcesses, ISet<int> runningProcessIds)
        {
